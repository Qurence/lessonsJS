...
// btn1.addEventListener("click", () => console.log("click"));
// btn2.addEventListener("contextmenu", () => console.log("ContextMenu"));
// btn3.addEventListener("mouseout", () => console.log("mouse")); // mouseover - mmouseover 
// btn4.addEventListener("mouseup", () => console.log("click mouse")); // mousedown - mouseup
// btn5.addEventListener("mousemove", () => console.log("mousemove"));

// btn6.addEventListener("keydown", () => console.log("keydown")); // независимо на что повешать слушатель
...
// function handleSubmit(event) {
//     event.preventDefault(); // отменяет действие по умолчанию !!
//     const login = loginInput.value;
//     const password = passInput.value;
...
// parent.addEventListener("click", hundleClick);
