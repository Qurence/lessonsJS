...
//   let count = 0;
//   return function () {
//     count += step || 1; // Якщо крок не вказано, то збільшуємо на 1
//     console.log(count);
//   };
// }

// const counter_1 = createCounter();
// const counter_2 = createCounter(5);
// counter_1();
// counter_2();
// counter_1();
// counter_2();
...
//     console.log("green");
//   }
//   //   (change ? this.style.background = "green" change = false : this.style.background = "red");
// }
...
//     output.textContent = "В корзині: " + this.items;
//   },
// };
...
// infoCar.showInfo(); // Виклик методу без контексту
